import*as e from"../../../ui/lit/lit.js";import*as t from"../../../ui/legacy/legacy.js";import"../../../ui/components/icon_button/icon_button.js";import*as o from"../../../core/i18n/i18n.js";import*as r from"../../../ui/components/buttons/buttons.js";import*as s from"../../../ui/components/input/input.js";import*as i from"../../../ui/visual_logging/visual_logging.js";import*as n from"../models/models.js";import*as a from"../../../ui/components/helpers/helpers.js";import*as l from"../extensions/extensions.js";import*as c from"../../../core/host/host.js";import*as d from"../../../core/platform/platform.js";import*as p from"../../../core/sdk/sdk.js";import*as u from"../../../third_party/codemirror.next/codemirror.next.js";import*as h from"../../../ui/components/code_highlighter/code_highlighter.js";import"../../../ui/components/dialogs/dialogs.js";import*as v from"../../../ui/components/text_editor/text_editor.js";import*as g from"../../../ui/components/menus/menus.js";import*as b from"../../../ui/components/suggestion_input/suggestion_input.js";import*as m from"../controllers/controllers.js";import*as y from"../util/util.js";var f={cssText:`*{margin:0;padding:0;box-sizing:border-box;font-size:inherit}.control{background:none;border:none;display:flex;flex-direction:column;align-items:center}.control[disabled]{filter:grayscale(100%);cursor:auto}.icon{display:flex;width:40px;height:40px;border-radius:50%;background:var(--sys-color-error-bright);margin-bottom:8px;position:relative;transition:background 200ms;place-content:center center;align-items:center}.icon::before{--override-white:#fff;box-sizing:border-box;content:"";display:block;width:14px;height:14px;border:1px solid var(--override-white);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background-color:var(--override-white)}.icon.square::before{border-radius:0}.icon.circle::before{border-radius:50%}.icon:hover{background:color-mix(in srgb,var(--sys-color-error-bright),var(--sys-color-state-hover-on-prominent) 10%)}.icon:active{background:color-mix(in srgb,var(--sys-color-error-bright),var(--sys-color-state-ripple-neutral-on-prominent) 16%)}.control[disabled] .icon:hover{background:var(--sys-color-error)}.label{font-size:12px;line-height:16px;text-align:center;letter-spacing:0.02em;color:var(--sys-color-on-surface)}\n/*# sourceURL=${import.meta.resolve("./controlButton.css")} */\n`},x=self&&self.__decorate||function(e,t,o,s){var i,r=arguments.length,n=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,o):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,s);else for(var a=e.length-1;a>=0;a--)(i=e[a])&&(n=(r<3?i(n):r>3?i(t,o,n):i(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};const w=new CSSStyleSheet;w.replaceSync(f.cssText);const{html:S,Decorators:k,LitElement:$}=e,{customElement:E,property:C}=k;let R=class extends ${static styles=[w];constructor(){super(),this.label="",this.shape="square",this.disabled=!1}#e=e=>{this.disabled&&(e.stopPropagation(),e.preventDefault())};render(){return S`
        ...
        <div class="wrapper">
          ...
          <input
            value=${A(this.#i?.selectorAttribute)}
          ...
          <div class="checkbox-container">
            ${Object.values(n.Schema.SelectorType).map(e=>{const o=this.#i?.getSelectorByType(e);return j`
    ...
    `}#te=e=>{const t=e.target,o=t.step||t.section?.causingStep;o&&!this.#L&&this.#se(o)};#ee(e){e.stopPropagation();const t=e.target,o=t.step||t.section?.causingStep||null;this.#L!==o&&(this.#L=o,this.#r(),o&&this.#se(o,!0))}#ie(){void 0!==this.#L&&(this.#L=void 0,this.#r())}#re(e){"Enter"===e.key&&(e.preventDefault(),this.#ne(e))}#ne(e){e.stopPropagation(),this.#P=!this.#P,this.#r()}#ae(e){const t=e.target;if(t instanceof HTMLSelectElement){const e=Ae.find(e=>e.i18nTitleKey===t.value);this.dispatchEvent(new Ne(e?.i18nTitleKey===p.NetworkManager.NoThrottlingConditions.i18nTitleKey?void 0:e))}}#le(e){const t=e.target;t.checkValidity()?this.dispatchEvent(new je(Number(t.value))):t.reportValidity()}#ce=e=>{const t=e.target.innerText.trim();if(!t)return this.#T=!0,void this.#r();this.dispatchEvent(new Ie(t))};#de=e=>{switch(e.code){case"Escape":case"Enter":e.target.blur(),e.stopPropagation()}};#pe=()=>{const e=this.#t.getElementById("title-input");e.focus();const t=document.createRange();t.selectNodeContents(e),t.collapse(!1);const o=window.getSelection();o?.removeAllRanges(),o?.addRange(t)};#he=e=>{const t=e.target;t.matches(".wrapping-label")&&t.querySelector("devtools-select-menu")?.click()};async#ue(e){let t=[...this.#A,...this.#O].find(e=>e.getId()===this.#i?.preferredCopyFormat);if(t||(t=this.#A[0]),!t)throw new Error("No default converter found");let o="";e?o=await t.stringifyStep(e):this.#S&&([o]=await t.stringify(this.#S)),c.InspectorFrontendHost.InspectorFrontendHostInstance.copyText(o);const s=e?function(e){switch(e){case"puppeteer":case"puppeteer-firefox":return 5;case"json":return 6;case"@puppeteer/replay":return 7;default:return 8}}(t.getId()):function(e){switch(e){case"puppeteer":case"puppeteer-firefox":return 1;case"json":return 2;case"@puppeteer/replay":return 3;default:return 4}}(t.getId());c.userMetrics.recordingCopiedToClipboard(s)}#oe(e){e.stopPropagation(),this.#ue(e.step)}async#q(e){e.target===document.body&&(e.preventDefault(),await this.#ue(this.#L),c.userMetrics.keyboardShortcutFired("chrome-recorder.copy-recording-or-step"))}#ve(){if(!this.#f)return xe``;const t=[];this.#f.viewportSettings&&(t.push(xe`<div>${this.#f.viewportSettings.isMobile?ke(we.mobile):ke(we.desktop)}</div>`),t.push(xe`<div class="separator"></div>`),t.push(xe`<div>${this.#f.viewportSettings.width}×${this.#f.viewportSettings.height} px</div>`));const s=[];if(this.#P){const e=this.#f.networkConditionsSettings?.i18nTitleKey||p.NetworkManager.NoThrottlingConditions.i18nTitleKey,t=Ae.find(t=>t.i18nTitleKey===e);let o="";t&&(o=t.title instanceof Function?t.title():t.title),s.push(xe`<div class="editable-setting">
      ...
      </div>`),s.push(xe`<div class="editable-setting">
      ...
      </div>`)}else this.#f.networkConditionsSettings?this.#f.networkConditionsSettings.title?s.push(xe`<div>${this.#f.networkConditionsSettings.title}</div>`):s.push(xe`<div>
            ${ke(we.download,{value:o.ByteUtilities.bytesToString(this.#f.networkConditionsSettings.download)})},
            ${ke(we.upload,{value:o.ByteUtilities.bytesToString(this.#f.networkConditionsSettings.upload)})},
            ${ke(we.latency,{value:this.#f.networkConditionsSettings.latency})}
          </div>`):s.push(xe`<div>${p.NetworkManager.NoThrottlingConditions.title instanceof Function?p.NetworkManager.NoThrottlingConditions.title():p.NetworkManager.NoThrottlingConditions.title}</div>`),s.push(xe`<div class="separator"></div>`),s.push(xe`<div>${ke(we.timeout,{value:this.#f.timeout||n.RecordingPlayer.defaultTimeout})}</div>`);const r=!this.#$&&!this.#k.isPlaying,a={"settings-title":!0,expanded:this.#P},l={expanded:this.#P,settings:!0};return xe`
      <div class="settings-row">
        <div class="settings-container">
          ...
          <div class=${e.Directives.classMap(l)}>
            ${s.length?s:xe`<div>${ke(we.default)}</div>`}
          </div>
        </div>
        <div class="settings-container">
    ...
    `}#ge(){return[...this.#A||[],...this.#O||[]].find(e=>e.getId()===this.#_)||this.#A[0]}#be(){if(this.#G)return xe`
        <devtools-recorder-extension-view .descriptor=${this.#G}>
      ...
      `;const t=this.#ge(),o=t?.getFormatName();return xe`
        <devtools-split-view
          ...
          sidebar-visibility=${this.#B?"":"hidden"}
        >
          <div slot="main">
            ${this.#me()}
          </div>
          <div slot="sidebar" jslog=${i.pane("source-code").track({resize:!0})}>
            ...
            <div class="section-toolbar" jslog=${i.toolbar()}>
              ...
              >
                ${this.#A.map(e=>xe`<devtools-menu-item
                    .value=${e.getId()}
                    .selected=${this.#_===e.getId()}
                    jslog=${i.action().track({click:!0}).context(`converter-${d.StringUtilities.toKebabCase(e.getId())}`)}
                  >
                    ${e.getFormatName()}
                  </devtools-menu-item>`)}
                ${this.#O.map(e=>xe`<devtools-menu-item
                    .value=${e.getId()}
                    .selected=${this.#_===e.getId()}
      ...
      `}#ye(){if(!this.#V)throw new Error("Unexpected: trying to render the text editor without editorState");return xe`
    ...
    `:null}#we(){return this.#k.isPlaying?xe`
        <devtools-button .jslogContext=${"abort-replay"} @click=${this.#Q} .iconName=${"pause"} .variant=${"outlined"}>
          ${ke(we.cancelReplay)}
        </devtools-button>`:xe`<devtools-replay-section
        .data=${{settings:this.#i,replayExtensions:this.#y}}
        .disabled=${this.#k.isPlaying}
        @startreplay=${this.#W}
        >
      </devtools-replay-section>`}#ke(e){e.stopPropagation(),this.dispatchEvent(new Ee({targetPanel:"timeline",speed:"normal"}))}showCodeToggle=()=>{this.#B=!this.#B,c.userMetrics.recordingCodeToggled(this.#B?1:2),this.#H()};#H=async()=>{if(!this.#S)return;const e=this.#ge();if(!e)return;const[t,o]=await e.stringify(this.#S);this.#F=t,this.#D=o,this.#D?.shift();const s=e.getMediaType(),i=s?await h.CodeHighlighter.languageFromMIME(s):null;this.#V=u.EditorState.create({doc:this.#F,extensions:[v.Config.baseConfiguration(this.#F),u.EditorState.readOnly.of(!0),u.EditorView.lineWrapping,i||[]]}),this.#r(),this.dispatchEvent(new Event("code-generated"))};#se=(e,t=!1)=>{if(!this.#D)return;const o=this.#C.indexOf(e);if(-1===o)return;const s=this.#t.querySelector("devtools-text-editor");if(!s)return;const i=s.editor;if(!i)return;const r=this.#D[2*o],n=this.#D[2*o+1];let a=s.createSelection({lineNumber:r+n,columnNumber:0},{lineNumber:r,columnNumber:0});const l=s.state.doc.lineAt(a.main.anchor);a=s.createSelection({lineNumber:r+n-1,columnNumber:l.length+1},{lineNumber:r,columnNumber:0}),i.dispatch({selection:a,effects:t?[u.EditorView.scrollIntoView(a.main,{y:"nearest"})]:void 0})};#fe=e=>{this.#_=e.itemValue,this.#i&&(this.#i.preferredCopyFormat=e.itemValue),this.#H()};#me(){return xe`
      <div class="sections">
      ${this.#B?"":xe`<div class="section-toolbar">
        <devtools-button
          @click=${this.showCodeToggle}
          class="show-code"
              ...
              <div class="content">
                <div class="steps">
                  <devtools-step-view
                    @click=${this.#ee}
                    @mouseover=${this.#te}
                    .data=${{section:e,state:this.#J(e),isStartOfGroup:!0,isEndOfGroup:0===e.steps.length,isFirstSection:0===t,isLastSection:t===this.#j.length-1&&0===e.steps.length,isSelected:this.#L===(e.causingStep||null),sectionIndex:t,isRecording:this.#$,isPlaying:this.#k.isPlaying,error:"error"===this.#J(e)?this.#N:void 0,hasBreakpoint:!1,removable:this.#C.length>1&&e.causingStep}}
                  >
                  </devtools-step-view>
                  ${e.steps.map(o=>this.#Z(e,o,t===this.#j.length-1))}
                  ${!this.#E&&this.#$&&t===this.#j.length-1?xe`<devtools-button
                  ...
                  ${this.#$&&t===this.#j.length-1?xe`<div class="step recording">${ke(we.recording)}</div>`:null}
                </div>
              </div>
            </div>
      `)}
      </div>
    `}#Se(){if(!this.#S)return"";const{title:t}=this.#S,o=!this.#k.isPlaying&&!this.#$;return xe`
      <div class="header">
        <div class="header-title-wrapper">
          <div class="header-title">
            <span @blur=${this.#ce}
                  ...
                  class=${e.Directives.classMap({"has-error":this.#T,disabled:!o})}
          ...
          ${this.#T?xe`<div class="title-input-error-text">
            ${ke(we.requiredTitleError)}
          </div>`:""}
        </div>
        ${!this.#$&&this.#M?xe`<div class="actions">
                <devtools-button
                  @click=${this.#ke}
                  .data=${{disabled:this.#k.isPlaying,variant:"outlined",iconName:"performance",title:ke(we.performancePanel),jslogContext:"measure-performance"}}
                >
    ...
    `}#r(){const t={wrapper:!0,"is-recording":this.#$,"is-playing":this.#k.isPlaying,"was-successful":"Success"===this.#z,"was-failure":"Failure"===this.#z};e.render(xe`
      <div @click=${this.#ie} class=${e.Directives.classMap(t)}>
        <div class="main">
          ${this.#Se()}
          ${this.#G?xe`
            <devtools-recorder-extension-view .descriptor=${this.#G}>
    ...
    `}#Ne(e){return this.#c.action?n.Tooltip.getTooltipForActions(e,this.#c.action):""}#r=()=>{const t=Boolean(this.#c.groups.length),o=t?this.#c.groups.flatMap(e=>e.items):this.#c.items,s=o.find(e=>e.value===this.#c.value)||o[0];if(!s)return;const r={primary:"primary"===this.#c.variant,secondary:"outlined"===this.#c.variant},n="outlined"===this.#c.variant?"outlined":"primary",a=s.buttonLabel?s.buttonLabel():s.label();e.render(Oe`
      <div class="select-button" title=${Fe(this.#Ne(a))}>
      <select
      class=${De(r)}
      ?disabled=${this.#c.disabled}
      jslog=${i.dropDown("network-conditions").track({change:!0})}
      @change=${this.#Te}>
        ${t?this.#c.groups.map(e=>this.#Ce(e,s)):this.#c.items.map(e=>this.#Re(e,s))}
    </select>
        ${s?Oe`
        <devtools-button
            .disabled=${this.#c.disabled}
    ...
    ></devtools-button>`}};Je([st({type:Boolean})],bt.prototype,"disabled",void 0),bt=Je([rt("devtools-recorder-selector-picker-button")],bt);let mt=class extends ot{static styles=[Ze];#Ie=new Set;constructor(){super(),this.state={type:n.Schema.StepType.WaitForElement},this.isTypeEditable=!0,this.disabled=!1}createRenderRoot(){const e=super.createRenderRoot();return e.addEventListener("keydown",this.#Le),e}set step(e){this.state=qe(gt.fromStep(e)),this.error=void 0}#Pe(e){try{this.dispatchEvent(new vt(gt.toStep(e))),this.state=e}catch(e){this.error=e.message}}#Me=e=>{e.preventDefault(),e.stopPropagation(),this.#Pe(Ye(this.state,{target:e.data.target,frame:e.data.frame,selectors:e.data.selectors.map(e=>"string"==typeof e?[e]:e),offsetX:e.data.offsetX,offsetY:e.data.offsetY}))};#Ae=(e,t,o)=>s=>{s.preventDefault(),s.stopPropagation(),this.#Pe(Ye(this.state,e)),this.#Oe(t),o&&c.userMetrics.recordingEdited(o)};#Le=e=>{if(He(e instanceof KeyboardEvent),e.target instanceof b.SuggestionInput.SuggestionInput&&"Enter"===e.key){e.preventDefault(),e.stopPropagation();const t=this.renderRoot.querySelectorAll("devtools-suggestion-input"),o=[...t].findIndex(t=>t===e.target);o>=0&&o+1<t.length?t[o+1].focus():e.target.blur()}};#Be=e=>t=>{if(He(t.target instanceof b.SuggestionInput.SuggestionInput),t.target.disabled)return;const o=lt[e.attribute],s=at[o](t.target.value),i=e.from.bind(this)(s);i&&(this.#Pe(Ye(this.state,i)),e.metric&&c.userMetrics.recordingEdited(e.metric))};#Fe=async e=>{if(He(e.target instanceof b.SuggestionInput.SuggestionInput),e.target.disabled)return;const t=e.target.value;t!==this.state.type&&(Object.values(n.Schema.StepType).includes(t)?(this.#Pe(await gt.default(t)),c.userMetrics.recordingEdited(9)):this.error=ht(pt.unknownActionType))};#_e=async e=>{e.preventDefault(),e.stopPropagation();const t=e.target.dataset.attribute;this.#Pe(Ye(this.state,{[t]:await gt.defaultByAttribute(this.state,t)})),this.#Oe(`[data-attribute=${t}].attribute devtools-suggestion-input`)};#Ve(e){if(!this.disabled)return Qe`
      <devtools-button
        ...
        @click=${e.onClick}
      ></devtools-button>
    `}#De(e){if(!this.disabled)return[...dt[this.state.type].optional].includes(e)&&!this.disabled?Qe`<devtools-button
      .size=${"SMALL"}
      .iconName=${"bin"}
      .variant=${"icon"}
      ...
      @click=${t=>{t.preventDefault(),t.stopPropagation(),this.#Pe(Ye(this.state,{[e]:void 0}))}}
    ></devtools-button>`:void 0}#Ge(e){return this.#Ie.add("type"),Qe`<div class="row attribute" data-attribute="type" jslog=${i.treeItem("type")}>
      ...
      <devtools-suggestion-input
        ...
        @blur=${this.#Fe}
      ></devtools-suggestion-input>
    </div>`}#Ue(e){this.#Ie.add(e);const t=this.state[e]?.toString();if(void 0!==t)return Qe`<div class="row attribute" data-attribute=${e} jslog=${i.treeItem(d.StringUtilities.toKebabCase(e))}>
      ...
      <devtools-suggestion-input
        ...
        @blur=${this.#Be({attribute:e,from(t){if(void 0!==this.state[e])return"properties"===e&&c.userMetrics.recordingAssertion(2),{[e]:t}},metric:10})}
      ></devtools-suggestion-input>
      ${this.#De(e)}
    </div>`}#qe(){if(this.#Ie.add("frame"),void 0!==this.state.frame)return Qe`
        ...
        ${this.state.frame.map((e,t,o)=>Qe`
            <div class="padded row">
              <devtools-suggestion-input
                ...
                .value=${nt(e.toString())}
                data-path=${`frame.${t}`}
                @blur=${this.#Be({attribute:"frame",from(e){if(void 0!==this.state.frame?.[t])return{frame:new Xe({[t]:e})}},metric:10})}
              ></devtools-suggestion-input>
              ${this.#Ve({class:"add-frame",title:ht(pt.addFrameIndex),iconName:"plus",onClick:this.#Ae({frame:new Xe({[t+1]:new We(ct.frame[0])})},`devtools-suggestion-input[data-path="frame.${t+1}"]`,10)})}
              ${this.#Ve({class:"remove-frame",title:ht(pt.removeFrameIndex),iconName:"minus",onClick:this.#Ae({frame:new Xe({[t]:void 0})},`devtools-suggestion-input[data-path="frame.${Math.min(t,o.length-2)}"]`,10)})}
            </div>
          `)}
      </div>
    `}#He(){if(this.#Ie.add("selectors"),void 0!==this.state.selectors)return Qe`<div class="attribute" data-attribute="selectors" jslog=${i.treeItem("selectors")}>
      <div class="row">
        <div>selectors<span class="separator">:</span></div>
        <devtools-recorder-selector-picker-button
          @selectorpicked=${this.#Me}
          .disabled=${this.disabled}
        ></devtools-recorder-selector-picker-button>
        ${this.#De("selectors")}
      </div>
      ${this.state.selectors.map((e,t,o)=>Qe`<div class="padded row" data-selector-path=${t}>
            ...
            ${this.#Ve({class:"add-selector",title:ht(pt.addSelector),iconName:"plus",onClick:this.#Ae({selectors:new Xe({[t+1]:new We(structuredClone(ct.selectors[0]))})},`devtools-suggestion-input[data-path="selectors.${t+1}.0"]`,4)})}
            ${this.#Ve({class:"remove-selector",title:ht(pt.removeSelector),iconName:"minus",onClick:this.#Ae({selectors:new Xe({[t]:void 0})},`devtools-suggestion-input[data-path="selectors.${Math.min(t,o.length-2)}.0"]`,5)})}
          </div>
          ${e.map((e,o,s)=>Qe`<div
            ...
            >
              <devtools-suggestion-input
                ...
                @blur=${this.#Be({attribute:"selectors",from(e){if(void 0!==this.state.selectors?.[t]?.[o])return{selectors:new Xe({[t]:new Xe({[o]:e})})}},metric:7})}
              ></devtools-suggestion-input>
              ${this.#Ve({class:"add-selector-part",title:ht(pt.addSelectorPart),iconName:"plus",onClick:this.#Ae({selectors:new Xe({[t]:new Xe({[o+1]:new We(ct.selectors[0][0])})})},`devtools-suggestion-input[data-path="selectors.${t}.${o+1}"]`,6)})}
              ${this.#Ve({class:"remove-selector-part",title:ht(pt.removeSelectorPart),iconName:"minus",onClick:this.#Ae({selectors:new Xe({[t]:new Xe({[o]:void 0})})},`devtools-suggestion-input[data-path="selectors.${t}.${Math.min(o,s.length-2)}"]`,8)})}
            </div>`)}`)}
    </div>`}#Ke(){if(this.#Ie.add("assertedEvents"),void 0!==this.state.assertedEvents)return Qe`<div class="attribute" data-attribute="assertedEvents" jslog=${i.treeItem("asserted-events")}>
      <div class="row">
        <div>asserted events<span class="separator">:</span></div>
        ${this.#De("assertedEvents")}
      </div>
      ${this.state.assertedEvents.map((e,t)=>Qe` <div class="padded row" jslog=${i.treeItem("event-type")}>
          ...
          <div class="padded row" jslog=${i.treeItem("event-title")}>
            ...
            <devtools-suggestion-input
              ...
              .value=${nt(e.title??"")}
              @blur=${this.#Be({attribute:"assertedEvents",from(e){if(void 0!==this.state.assertedEvents?.[t]?.title)return{assertedEvents:new Xe({[t]:{title:e}})}},metric:10})}
            ></devtools-suggestion-input>
          </div>
          <div class="padded row" jslog=${i.treeItem("event-url")}>
            ...
            <devtools-suggestion-input
              ...
              .value=${nt(e.url??"")}
              @blur=${this.#Be({attribute:"url",from(e){if(void 0!==this.state.assertedEvents?.[t]?.url)return{assertedEvents:new Xe({[t]:{url:e}})}},metric:10})}
            ></devtools-suggestion-input>
          </div>`)}
    </div> `}#Xe(){if(this.#Ie.add("attributes"),void 0!==this.state.attributes)return Qe`<div class="attribute" data-attribute="attributes" jslog=${i.treeItem("attributes")}>
      <div class="row">
        <div>attributes<span class="separator">:</span></div>
        ${this.#De("attributes")}
      </div>
      ${this.state.attributes.map(({name:e,value:t},o,s)=>Qe`<div class="padded row" jslog=${i.treeItem("attribute")}>
          <devtools-suggestion-input
            .disabled=${this.disabled}
            ...
            @blur=${this.#Be({attribute:"attributes",from(e){if(void 0!==this.state.attributes?.[o]?.name)return c.userMetrics.recordingAssertion(3),{attributes:new Xe({[o]:{name:e}})}},metric:10})}
          ></devtools-suggestion-input>
          ...
          <devtools-suggestion-input
            ...
            @blur=${this.#Be({attribute:"attributes",from(e){if(void 0!==this.state.attributes?.[o]?.value)return c.userMetrics.recordingAssertion(3),{attributes:new Xe({[o]:{value:e}})}},metric:10})}
          ></devtools-suggestion-input>
          ${this.#Ve({class:"add-attribute-assertion",title:ht(pt.addSelectorPart),iconName:"plus",onClick:this.#Ae({attributes:new Xe({[o+1]:new We((()=>{{const e=new Set(s.map(({name:e})=>e)),t=ct.attributes[0];let o=t.name,i=0;for(;e.has(o);)++i,o=`${t.name}-${i}`;return{...t,name:o}}})())})},`devtools-suggestion-input[data-path="attributes.${o+1}.name"]`,10)})}
          ${this.#Ve({class:"remove-attribute-assertion",title:ht(pt.removeSelectorPart),iconName:"minus",onClick:this.#Ae({attributes:new Xe({[o]:void 0})},`devtools-suggestion-input[data-path="attributes.${Math.min(o,s.length-2)}.value"]`,10)})}
        </div>`)}
    </div>`}#Qe(){return[...dt[this.state.type].optional].filter(e=>void 0===this.state[e]).map(e=>Qe`<devtools-button
          .variant=${"outlined"}
          class="add-row"
          data-attribute=${e}
        ...
        </devtools-button>`)}#Oe=e=>{this.updateComplete.then(()=>{const t=this.renderRoot.querySelector(e);t?.focus()})};render(){this.#Ie=new Set;const e=Qe`
      <div class="wrapper" jslog=${i.tree("step-editor")}>
        ${this.#Ge(this.isTypeEditable)} ${this.#Ue("target")}
        ${this.#qe()} ${this.#He()}
        ${this.#Ue("deviceType")} ${this.#Ue("button")}
        ${this.#Ue("url")} ${this.#Ue("x")}
        ${this.#Ue("y")} ${this.#Ue("offsetX")}
        ${this.#Ue("offsetY")} ${this.#Ue("value")}
        ${this.#Ue("key")} ${this.#Ue("operator")}
        ${this.#Ue("count")} ${this.#Ue("expression")}
        ${this.#Ue("duration")} ${this.#Ke()}
        ${this.#Ue("timeout")} ${this.#Ue("width")}
        ${this.#Ue("height")} ${this.#Ue("deviceScaleFactor")}
        ${this.#Ue("isMobile")} ${this.#Ue("hasTouch")}
        ${this.#Ue("isLandscape")} ${this.#Ue("download")}
        ${this.#Ue("upload")} ${this.#Ue("latency")}
        ${this.#Ue("name")} ${this.#Ue("parameters")}
        ${this.#Ue("visible")} ${this.#Ue("properties")}
        ${this.#Xe()}
        ${this.error?Qe`
              <div class="error">

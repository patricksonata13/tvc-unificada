        ...
        <div class="wrapper">
          <div class="header" jslog=${v.toolbar()}>
            ...
            <devtools-button
              id='origin'
              @click=${this.#te}
              on-render=${h.Directives.nodeRenderedCallback(e=>{this.#s=e})}
